...
public class Ass1LCRSimulator {
    ...
    public static String LCRSimulator(int numOfProcessors){
        int leaderID = 0;
        int leaderRound = 0;
        ...
        String simResults = "The leader ID is: " + leaderID + " elected in round: " + leaderRound + " with number of sent message: " + leaderMessageSent;
