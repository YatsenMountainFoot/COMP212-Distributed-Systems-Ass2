...
public class Ass1HSSimulator {
    ...
    public static String HSSimulator(int numOfProcessors){
        int leaderID = 0;
        int leaderRound = 0;
        ...
        do {
         //for(int i = 0; i < 10; i++) {
           ...
           // }
            ...
            String simResult = "The leader ID is: " + leaderID + " elected in Phase: " + leaderPhase + " round:" + leaderRound + " with number of sent message: " + leaderMessageSent;
